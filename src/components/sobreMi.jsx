        ...
        <div className={styles.posgrados}>
          <h2>{data.navbar.formacion}</h2>
           <ul>
            ...
            <li className={styles.formacion}><span className={styles.bold}>Myofasziale instrumentelle Fibrolyse (Häkchen)</span> - 30 Stunden</li>
